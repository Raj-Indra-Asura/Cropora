...
class ScanActivity : AppCompatActivity() {
    ...
    private fun createImageUri(): Uri {
        ...
        val imageFile = File(imageDirectory, "cropora_${System.currentTimeMillis()}.jpg")
    ...
    private fun copyUriToCacheFile(imageUri: Uri): File {
        val uploadFile = File(cacheDir, "cropora_upload_${System.currentTimeMillis()}.jpg")
        try {
